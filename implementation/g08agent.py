...
class G08Agent:
    def __init__(self, env, player="player_1"):
        self.env = env
        ...
        if player == "player_1":
            self.actor.load_state_dict(torch.load("./model/actor_player_1.pth"))
        else:
            self.actor.load_state_dict(torch.load("./model/actor_player_2.pth"))
