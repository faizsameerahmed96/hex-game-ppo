...
CENTER_WEIGHT = 2 # more focused


def train_smart_random_2(hyperparameters):
    """
    ...
    player_1_model.load_model_for("player_1", '/Users/faizahmed/Documents/SJSU/Reinforcement Learning/pa5/experiments/smart_random_1_5/checkpoints/player_1/1733135194.4381151')
    player_2_model = PPO(
        policy_class=PolicyValueNetwork,
        env=env,
        **{**hyperparameters, "current_agent_player": "player_2", "opponent": SmartRandomOpponent(player="player_1", center_weight=CENTER_WEIGHT)}
    )
    player_2_model.load_model_for("player_2", '/Users/faizahmed/Documents/SJSU/Reinforcement Learning/pa5/experiments/smart_random_1_5/checkpoints/player_2/1733135351.394225')
